...
var getWeatherInfo = function (cityname) {
    ...
    fetch(
        ...
        .then(function (cityResponse) {
            ...
            return fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + latitude + '&lon=' + longitude + '&exclude=alerts,minutely,hourly&units=imperial&appid=398658471f4b8d16e4e261406f768e40');
        })
